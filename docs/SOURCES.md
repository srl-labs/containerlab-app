...
The initial app guides were copied from [srl-labs/containerlab](https://github.com/srl-labs/containerlab/tree/8c9679a374d3ee90eb20343b3d127fdd018e694f/docs) at commit `8c9679a374d3ee90eb20343b3d127fdd018e694f` on 2026-09-17:

- `docs/manual/gui/` (shared workspace, VS Code, web, desktop)
- `docs/manual/api-server.md`
- `docs/images/gui/` and the Containerlab favicon
