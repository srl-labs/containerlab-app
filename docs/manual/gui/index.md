...
```clab file="examples/fabric.clab.yml" annotations="examples/fabric.clab.yml.annotations.json" title="The topology canvas" height="440"
```

This embedded example is read-only. In the app, the same canvas also lets you add and connect nodes.
