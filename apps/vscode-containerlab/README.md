...
[![GitHub releases](https://img.shields.io/github/v/release/srl-labs/containerlab-app.svg?filter=vscode-v*&style=flat-square&color=00c9ff&labelColor=bec8d2)](https://github.com/srl-labs/containerlab-app/releases)
...
![screencast](https://raw.githubusercontent.com/srl-labs/containerlab-app/refs/heads/main/apps/vscode-containerlab/resources/screenshot.png)
...
This extension lives in `apps/vscode-containerlab` in the
[containerlab-app monorepo](https://github.com/srl-labs/containerlab-app).
Run `npm install` from the repository root, then use:
...
The extension consumes `packages/clab-ui` through npm workspaces. The root build
and packaging commands build that shared UI first. There is one root lockfile.
Use the root VS Code launch configuration to debug the extension.
...
- **GitHub Issues:** [Create an issue](https://github.com/srl-labs/containerlab-app/issues) on GitHub.
